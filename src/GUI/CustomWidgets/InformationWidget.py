...
class InformationWidget(QWidget):
    def __init__(self, parent):
        ...
        self.PushButton_2 = PushButton(self.widget_11)
        self.PushButton_2.setObjectName(u"PushButton_2")
        self.horizontalLayout_11.addWidget(self.PushButton_2, 0, Qt.AlignBottom)
    ...
    def retranslateUi(self, Form):
        ...
        self.PushButton_2.setText(QCoreApplication.translate("Form", u"Skip", None))
