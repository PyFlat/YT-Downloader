...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout_2.setContentsMargins(35, 35, 35, 0)
    ...
    def retranslateUi(self, Form):
        ...
        self.custom_dl_line_edit.setPlaceholderText(QCoreApplication.translate("Form", u"Select your format", None))
        self.custom_dl_back_btn.setText(QCoreApplication.translate("Form", u"Back", None))
        self.custom_dl_next_btn.setText(QCoreApplication.translate("Form", u"Next", None))
        self.custom_dl_dl_btn.setText(QCoreApplication.translate("Form", u"Download", None))
        self.TitleLabel_2.setText(QCoreApplication.translate("Form", u"Video Selection", None))
        self.SubtitleLabel.setText(QCoreApplication.translate("Form", u"100 Videos", None))
        self.start_range_label.setText(QCoreApplication.translate("Form", u"0", None))
